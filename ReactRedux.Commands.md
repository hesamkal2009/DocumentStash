...
- npm i jest @types/jest @babel/core @babel/preset-env babel-jest -D    * Note: babel-jest might cause problems if it is already installed as dependency by another package *
- touch config.json
